    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[core.validators.color_validator], verbose_name='Цвет')),
                ('slug', models.SlugField(unique=True, validators=[core.validators.slug_validator], verbose_name='Уникальный слаг')),
            ],
            options={
                'verbose_name': 'тег',
